...
@Entity
@Immutable
@Table(name = "FORM_TOP20_SP_BAN_NHIEU")
@Subselect("select uuid() as id, SPBN.* FROM FORM_TOP20_SP_BAN_NHIEU SPBN")
public class Top20BanNhieu implements Serializable{
    ...
    public Top20BanNhieu() {}

    public Top20BanNhieu(String id, int maSanPham, String tenSanPham, double gia, String hinhAnh, double giaUuDai) {
